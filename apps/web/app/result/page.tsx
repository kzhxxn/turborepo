    ...
    >
      ...
      <section className='flex-1 flex flex-col 2xl:flex-row items-center justify-center gap-6 p-4'>
        ...
        <div className='flex flex-col md:w-[768px] h-[504px] md:h-[388px] gap-4 text-black text-left w-full '>
          ...
          src={data.download_url}
          alt={data.author}
          className='w-full md:w-1/2 max-w-md rounded-[20px]'
        />
        <div className='flex flex-col gap-4 text-black text-left w-full md:w-1/2 max-w-md'> */}
          <CardBox flex>
          ...
          <div className='w-full flex justify-center '>
            <Button
              className='w-full md:w-[154px] h-[48px] bg-black text-white text-[16px] leading-[148%] tracking-[-0.02em] font-semibold rounded-[12px]'
              onClick={() => router.push('/')}
            >
              이전
            </Button>
